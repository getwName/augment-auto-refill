...
**必填配置项**：
- **邮箱域名**：输入完整的邮箱后缀，如 `@gmail.com`、`@outlook.com`
- **随机长度**：设置邮箱前缀的字符数（建议8-12位）
...
|--------|------|----------|--------|--------|------|
| **邮箱域名** | 生成邮箱的后缀部分 | ✅ 必填 | 无 | `@gmail.com` | `@gmail.com`、`@outlook.com` |
| **随机长度** | 邮箱前缀的字符数 | ❌ 可选 | 10 | 8-12位 | `8`、`10`、`12` |

### 界面配置方式

**在扩展设置页面中**：
- **邮箱域名输入框**：直接输入完整域名（包含@符号）
- **随机长度输入框**：输入数字（建议8-12之间）
- **保存按钮**：点击保存配置
...
| 配置 | 邮箱域名 | 随机长度 | 生成结果示例 |
|------|----------|----------|--------------|
| 示例1 | `@gmail.com` | `8` | `A7k9Xm2P@gmail.com` |
| 示例2 | `@outlook.com` | `10` | `B3n8Yz5RqW@outlook.com` |
| 示例3 | `@yahoo.com` | `12` | `C9m4Kp7Lx6Qw@yahoo.com` |
